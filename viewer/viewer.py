"""
Refer to: 
https://github.com/hangg7/nerfview/blob/main/nerfview/viewer.py
"""
...
class Viewer(object):
    ...
    @property 
    def max_image_res(self): 
        if self._max_img_res_slider is None: 
            return 1280 # default resolution 
        else: 
